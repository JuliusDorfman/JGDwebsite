...
<ol style={{fontSize: '0.85rem', lineHeight: '1.8', listStyle: 'decimal', paddingLeft: '1.5rem'}}>
  <li>1. <a href="#whats-left-for-the-humans" className="neon-cyan">What's Left for the Humans?</a></li>
  <li>2. <a href="#perceived-accountability" className="neon-cyan">Perceived Accountability</a></li>
  <li>3. <a href="#throughput-vs-situational-awareness" className="neon-cyan">Throughput vs Situational Awareness</a></li>
  <li>4. <a href="#human-growth-and-want" className="neon-cyan">Human Growth and Want</a></li>
  <li>5. <a href="#the-bar-isnt-lower-its-different" className="neon-cyan">The Bar Isn't Lower, It's Different</a></li>
</ol>
...
<span id="whats-left-for-the-humans" className="neon-red">> What's left for the humans?</span>
...
<h2 id="perceived-accountability" className="neon-cyan">Perceived Accountability</h2>
...
<h2 id="throughput-vs-situational-awareness" className="neon-cyan">Throughput vs Situational Awareness</h2>
...
<h2 id="human-growth-and-want" className="neon-cyan">Human Growth and Want</h2>
...
<h2 id="the-bar-isnt-lower-its-different" className="neon-cyan">The Bar Isn't Lower, It's Different</h2>


The AI Assistant didn't replace your <span className="support-team">Support Team</span>. It freed up your team's bandwidth.
